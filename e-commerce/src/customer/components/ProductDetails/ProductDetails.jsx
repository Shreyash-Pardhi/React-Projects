...
import HomeScetionCard from '../HomeSectionCard/HomeScetionCard';
    ...
    return (
        <div className="bg-white lg:px-20">
            <div className="pt-6">
                ...
                <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gapy-y-10 px-4 pt-10'>
                    {/* Image gallery */}
                    ...
                    <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
                        <div className="lg:col-span-2">
                            <h1 className="text-lg lg:text-xl font-semibold text-grey-900">BRAND</h1>
                            <h1 className='text-lg lg:text-xl text-grey-900 opacity-60 pt-1'>discription</h1>
                        </div>
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <div className="mt-6">
                                <div className='flex items-center space-x-3'>
                                    ...
                                    <p className='opacity-50 text-sm'>5k ratings</p>
                                    <p className='ml-3 text-sm font-medium text-indigo-500 hover:text-indigo-700'>3k reviews</p>
                                </div>
                        ...
                        <Grid container spacing={7}>
                            ...
                            <Grid item xs={5}>
                                ...
                                <div className='flex item-center space-x-3'>
                                    ...
                                    <p className='opacity-60'>5k ratings</p>
                                </div>
                ...
                <section className='pt-10'>
                    ...
                    <div className='flex flex-wrap space-y-5'>
                        {mens_kurta.map((item)=><HomeScetionCard product={item}/>)}
                    </div>
                </section>
